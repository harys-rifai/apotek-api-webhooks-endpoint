...
urlpatterns = [
    ...
    path("api/db-vacuum-secondary/", views.api_db_vacuum_secondary, name="api_db_vacuum_secondary"),
    path("api/db-reindex/<str:db>/", views.api_db_reindex, name="api_db_reindex"),
    path("api/db-analyze/<str:db>/", views.api_db_analyze, name="api_db_analyze"),
    path("api/db-vacuum-analyze/<str:db>/", views.api_db_vacuum_analyze, name="api_db_vacuum_analyze"),
    path("api/db-backup-pg/<str:db>/", views.api_db_backup_pg, name="api_db_backup_pg"),
